        ...
        <div className="col-12 lg:col-4 py-3 lg:pl-6">
          ...
          <div className="flex align-items-center mb-5">
            ...
            <div
              ...
              style={{
                boxShadow:
                  color === "blue" ? "0 0 0 0.2rem var(--blue-500)" : undefined,
              }}
          ...
          <div className="grid">
            ...
            <div className="col-12 lg:col-4">
              ...
              <ul className="list-none p-0 m-0 text-600 mb-4 text-600">
                <li className="mb-3">
                  <span className="font-semibold">Leo vel:</span> Egestas
                  congue.
                </li>
                <li className="mb-3">
                  <span className="font-semibold">Sociis natoque:</span>{" "}
                  Parturient montes nascetur.
                </li>
                <li>
                  <span className="font-semibold">Suspendisse in:</span> Purus
                  sit amet volutpat.
                </li>
              </ul>
            </div>
