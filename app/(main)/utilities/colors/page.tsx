  ...
  return (
    <div className="card">
      ...
      <p>
        ...
        <span className="text-primary font-medium">var</span> syntax e.g.{" "}
        <span className="text-primary font-medium">var(--text-color)</span>.
      </p>
      ...
      <p>
        Color utility classes of PrimeFlex such as background, text and border
        use the exported CSS variables from the theme so PrimeFlex or
        PrimeBlocks are perfectly compatible with the provided themes.
      </p>
      ...
      <p>
        Following is the list of colors exported as CSS variables from the
        theme.
      </p>
      <div className="card">
      ...
      <h4>Color Palette</h4>
      <p>
        A palette consists of 9 colors where each color provides tints/shades
        from 50 to 900.
      </p>
      ...
      <h4>Surfaces</h4>
      <p>
        In addition, a theme brings a special palette called surfaces that can
        be used as the base when designing the surface layers and separators.
      </p>
      <div className="card">
